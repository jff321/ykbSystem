...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 按累计消费排序
      sortByFrozen(obj1, obj2){
        let val1 = Number(obj1.frozen);
        let val2 = Number(obj2.frozen);
        return val1 - val2
      },

      // 按今日花费排序
      sortByToday(obj1, obj2){
        let val1 = Number(obj1.today);
        let val2 = Number(obj2.today);
        return val1 - val2
      },
